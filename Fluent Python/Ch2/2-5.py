...
# tuple() accept one argument which could be an iterable object, generator is an
# interable object, so it could be used in tuple(). Also, when there is only one
# argument needed in the function call, the outside () of 
